...
const CHAPITRES = [
  {
    ...
    sections: [
      ...
      { titre: "Informations requises", contenu: null, type: "list", items: ["Dénomination officielle de l'institution", "Catégorie de service (hôpital, banque, mairie...)", "Adresse complète de l'établissement", "Numéro de téléphone principal", "Email professionnel", "Site web officiel (si disponible)"] },
      ...
      { titre: "Choisir votre plan", contenu: null, type: "plans" },
      { titre: "Documents à soumettre", contenu: null, type: "list", items: ["Institutions publiques : Acte officiel de création, numéro JO, pièce d'identité du responsable", "Entreprises privées : RCCM, NIF, agréments sectoriels, pièce d'identité du représentant", "Professionnels indépendants : Diplômes, numéro d'ordre professionnel, pièce d'identité valide", "Format accepté : PDF, JPG, PNG — max 10 MB"] },
      { titre: "Délais de validation", contenu: null, type: "list", items: ["📩 Accusé de réception : immédiat", "📩 Dossier en examen : dans les 24h", "📩 Documents complémentaires si besoin : 48h", "📩 Validation et activation : 72h ouvrées"] },
    ],
  },
  {
    ...
    sections: [
      ...
      { titre: "Logo et identité visuelle", contenu: null, type: "list", items: ["Format PNG ou JPG (fond transparent préféré)", "Dimensions min : 400×400 px — max 5 MB", "Photo de couverture Premium : 1200×400 px — max 10 MB", "Le logo apparaît dans les résultats et confirmations de RDV"] },
      ...
      { titre: "Progression du profil", contenu: null, type: "checklist", items: ["Informations générales complètes", "Logo uploadé", "Au moins 3 services renseignés", "Disponibilités configurées", "Document officiel soumis", "Badge vérifié obtenu"] },
    ],
  },
  {
    ...
    sections: [
      ...
      { titre: "Durée des créneaux", contenu: null, type: "list", items: ["15 min — consultations rapides, retraits de documents", "30 min — consultations médicales standard", "45 min — consultations spécialisées", "1 heure — bilans complets, consultations juridiques"] },
      ...
      { titre: "Conseils avancés", contenu: null, type: "list", items: ["💡 Réservez 2–3 créneaux libres/jour pour les urgences", "💡 Consultez vos statistiques pour identifier les pics", "💡 Anticipez Tabaski, Korité, vacances scolaires", "💡 Configurez un délai min de réservation (ex: 2h avant)"] },
    ],
  },
  {
    ...
    sections: [
      { titre: "Flux complet d'un RDV", contenu: null, type: "steps", items: ["Demande reçue — notification push + SMS + email", "Confirmation ou refus dans les 24h", "Rappels automatiques envoyés au citoyen J-1", "Jour du RDV — liste complète dans \"Aujourd'hui\"", "Marquage après RDV : Effectué / No-show / Reporté", "Invitation avis automatique 48h après le RDV"] },
      ...
      { titre: "Vues disponibles", contenu: null, type: "list", items: ["Vue Aujourd'hui — RDV du jour", "Vue Semaine — agenda hebdomadaire", "Vue Mois — visualisation avec compteurs", "Vue Liste — filtres par statut, service, période, citoyen"] },
      { titre: "Export (Plan Premium)", contenu: null, type: "list", items: ["PDF — impression et archivage", "Excel / CSV — vos outils internes", "iCal — Google Calendar, Outlook"] },
    ],
  },
  {
    ...
    sections: [
      { titre: "Plan PRO — Stats de base", contenu: null, type: "list", items: ["Nombre total de RDV par période", "Taux de confirmation et de no-show", "Vues du profil et note moyenne", "Évolution mensuelle des RDV"] },
      { titre: "Plan PREMIUM — Stats avancées", contenu: null, type: "list", items: ["Répartition des RDV par service", "Heatmap jours et heures de pointe", "Provenance géographique des citoyens", "Taux de conversion vues → RDV", "Comparaison mois/mois et année/année", "Rapports exportables PDF et Excel", "Rapport mensuel automatique le 1er du mois"] },
  ...
  },
  {
    ...
    sections: [
      ...
      { titre: "Types d'annonces autorisées", contenu: null, type: "list", items: ["✅ Changements d'horaires, fermetures temporaires", "✅ Nouveaux services ou nouveaux praticiens", "✅ Campagnes de santé, journées portes ouvertes", "✅ Alertes et communications officielles", "❌ Publicité commerciale excessive interdite", "❌ Contenu politique ou religieux interdit"] },
      ...
      { titre: "Bonnes pratiques", contenu: null, type: "list", items: ["Limitez-vous à 1–2 annonces actives simultanément", "Rédigez des messages courts et orientés vers l'action", "Supprimez les annonces obsolètes dès que possible"] },
    ],
  },
  {
    ...
    sections: [
      { titre: "Pourquoi le badge est crucial", contenu: null, type: "list", items: ["+65% de vues profil", "+80% de taux de conversion vers les RDV", "Meilleure position dans les résultats de recherche", "Badge visible sur toutes vos communications", "Accès aux fonctionnalités avancées"] },
      { titre: "Conditions d'éligibilité", contenu: null, type: "checklist", items: ["Profil complété à 100%", "Logo officiel uploadé", "Au moins 3 services renseignés", "Disponibilités configurées", "Documents justificatifs conformes", "Téléphone et email vérifiés", "Aucune violation des CGP"] },
      ...
      { titre: "Maintien du badge", contenu: null, type: "list", items: ["✅ Maintenez votre profil à jour en permanence", "✅ Renouvelez vos documents avant expiration", "✅ Respectez vos engagements envers les citoyens", "🔴 Retiré si signalements répétés fondés", "🔴 Retiré si informations manifestement fausses"] },
  ...
  },
  {
    ...
    sections: [
      { titre: "Comparatif des plans", contenu: null, type: "plans" },
      ...
      { titre: "Modes de paiement", contenu: null, type: "list", items: ["💳 Carte bancaire (Visa, Mastercard)", "📱 Mobile Money (Orange Money, MTN Guinée)", "🏦 Virement bancaire (institutions gouvernementales)", "💵 PayPal (diaspora et institutions internationales)"] },
  ...
  },
  {
    ...
    sections: [
      { titre: "Caractéristiques du QR Code", contenu: null, type: "list", items: ["✅ Unique — lié exclusivement à votre établissement", "✅ Permanent — ne change jamais", "✅ Gratuit — inclus dans tous les plans", "✅ Haute résolution — qualité d'impression professionnelle", "✅ Personnalisé — logo Yelen224 intégré au centre"] },
      ...
      { titre: "Dans votre établissement", contenu: null, type: "list", items: ["À l'entrée : panneau d'accueil \"Scannez pour prendre RDV\"", "En salle d'attente : affiche A4 ou A3", "À l'accueil / réception : support de comptoir", "Sur les portes des consultations et bureaux"] },
      { titre: "Sur vos supports", contenu: null, type: "list", items: ["Cartes de visite et ordonnances", "Flyers et brochures", "Site web et page Facebook officielle", "Signature email et WhatsApp Business"] },
  ...
  },
  {
    ...
    sections: [
      ...
      { titre: "Types de demandes", contenu: null, type: "list", items: ["[BUG] + description — problème technique", "[ABONNEMENT] + demande — facturation", "[SÉCURITÉ] + situation — compte compromis", "[PROFIL] + demande — modification de profil", "[PARTENARIAT] + institution — accord spécial"] },
...
function SectionBlock({ section, chapCouleur }) {
...
export default function GuidePrestatairePage() {
  ...
  const chap = CHAPITRES.find(c => c.id === activeChap);
  const idx = CHAPITRES.findIndex(c => c.id === activeChap);

  const niveauColor = n => n === "Débutant" ? "#22c55e" : n === "Intermédiaire" ? "#F5A623" : "#a855f7";
