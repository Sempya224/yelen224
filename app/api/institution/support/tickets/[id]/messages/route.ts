...
import { envoyerMessageInstitution } from "@/lib/supportTickets";
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const result = await envoyerMessageInstitution({ institutionId: membre.institutionId, ticketId: id, texte, req: request });
