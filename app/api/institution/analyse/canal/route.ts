...
import { calculerRepartitionCanal, FENETRE_JOURS, PERIODES_VALIDES } from "@/lib/analyseAggregation";

// Alimente le donut "Répartition par canal" du Centre d'Analyse.
export async function GET(req: NextRequest) {
  ...
  const canaux = await calculerRepartitionCanal(membre.institutionId, fenetreJours);
