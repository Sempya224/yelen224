...
const DOCUMENTS_PAR_CATEGORIE: Record<string, { label: string; description: string; formats: string; obligatoire: boolean }[]> = {
  ...
  "Pharmacie": [
    { label: "Autorisation d'exercice â€” Ordre National des Pharmaciens", description: "Document delivre par l'Ordre National des Pharmaciens de Guinee.", formats: "PDF, JPG", obligatoire: true },
    { label: "Registre de Commerce (RCCM)", description: "Extrait du registre de commerce.", formats: "PDF", obligatoire: true },
    { label: "Carte d'identification fiscale (NIF)", description: "Numero d'Identification Fiscale.", formats: "PDF, JPG", obligatoire: true },
  ],
  "Cabinet medical": [
    { label: "Autorisation d'exercice prive â€” Ministere de la Sante", description: "Autorisation officielle pour exercer la medecine en cabinet prive en Guinee.", formats: "PDF, JPG", obligatoire: true },
  ...
  "Transport / Logistique": [
    { label: "Licence de transport â€” Ministere des Transports", description: "Licence officielle delivree par le Ministere des Transports et des Infrastructures.", formats: "PDF", obligatoire: true },
    { label: "Registre de Commerce (RCCM)", description: "Extrait du registre de commerce.", formats: "PDF", obligatoire: true },
    { label: "Carte d'identification fiscale (NIF)", description: "Numero d'Identification Fiscale.", formats: "PDF, JPG", obligatoire: true },
  ],
  "ONG / Association": [
  ...
  "Autre": [
    ...
    { label: "Carte d'identification fiscale (NIF)", description: "Numero d'Identification Fiscale delivre par les autorites guinÃ©ennes.", formats: "PDF, JPG", obligatoire: false },
  ],
};
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#0D0D1A", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px", fontFamily: "'Segoe UI', sans-serif" }}>
      <div style={{ maxWidth: "480px", width: "100%", textAlign: "center" }}>
        ...
        <div style={{
          ...
          <p style={{ color: "#F5A623", fontSize: "12px", fontWeight: "700", textTransform: "uppercase", letterSpacing: "1px", margin: "0 0 8px" }}>
            Prochaines etapes
          </p>
        ...
        <button
          ...
          style={{ width: "100%", backgroundColor: "#F5A623", color: "#0D0D1A", border: "none", borderRadius: "12px", padding: "15px", fontSize: "15px", fontWeight: "700", cursor: "pointer" }}
        >
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#0D0D1A", fontFamily: "'Segoe UI', sans-serif", color: "#fff" }}>
      ...
      <header style={{
        ...
        borderBottom: "1px solid rgba(245,166,35,0.15)", padding: "0 24px"
      }}>
        <div style={{ maxWidth: "720px", margin: "0 auto", height: "60px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <span style={{ backgroundColor: "rgba(245,166,35,0.1)", border: "1px solid rgba(245,166,35,0.25)", color: "#F5A623", fontSize: "11px", fontWeight: "700", padding: "4px 12px", borderRadius: "20px", letterSpacing: "0.5px" }}>
            VERIFICATION
          </span>
        </div>
      </header>
      ...
      <main style={{ maxWidth: "720px", margin: "0 auto", padding: "36px 24px 60px" }}>
        ...
        <div style={{ marginBottom: "32px" }}>
          <p style={{ color: "#F5A623", fontSize: "11px", letterSpacing: "2px", textTransform: "uppercase", margin: "0 0 8px" }}>
            Dossier de verification
          </p>
          <h1 style={{ color: "#fff", fontSize: "26px", fontWeight: "800", margin: "0 0 10px" }}>
            Verification de votre etablissement
          </h1>
          <p style={{ color: "#666", fontSize: "14px", lineHeight: "1.7", margin: 0 }}>
            Pour garantir la confiance des citoyens guinÃ©ens, Yelen224 verifie l'authenticite de chaque etablissement. Les documents ci-dessous sont requis pour votre categorie : <strong style={{ color: "#F5A623" }}>{category}</strong>.
          </p>
        </div>
        ...
        <div style={{
          ...
          <div>
            <p style={{ color: "#93c5fd", fontSize: "13px", fontWeight: "600", margin: "0 0 4px" }}>
              Confidentialite et securite des donnees
            </p>
            <p style={{ color: "rgba(147,197,253,0.7)", fontSize: "12px", margin: 0, lineHeight: "1.6" }}>
              Vos documents sont chiffres et stockes de maniere securisee. Ils ne sont accessibles qu'aux agents de verification autorises de Yelen224 et sont traites conformement a la reglementation guinÃ©enne sur la protection des donnees.
            </p>
          </div>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "20px", marginBottom: "28px" }}>
          {docs.map((doc, i) => (
            <div key={i} style={{
              backgroundColor: "#13132A", border: "1px solid rgba(255,255,255,0.07)",
              ...
              <label className="upload-zone" style={{
                ...
                backgroundColor: files[doc.label] ? "rgba(34,197,94,0.05)" : "rgba(255,255,255,0.02)",
                border: `1px dashed ${files[doc.label] ? "rgba(34,197,94,0.4)" : "rgba(255,255,255,0.1)"}`,
                borderRadius: "12px", padding: "16px 20px", cursor: "pointer"
              }}>
                <div style={{
                  width: "44px", height: "44px", borderRadius: "10px", flexShrink: 0,
                  backgroundColor: files[doc.label] ? "rgba(34,197,94,0.15)" : "rgba(245,166,35,0.08)",
                  border: `1px solid ${files[doc.label] ? "rgba(34,197,94,0.3)" : "rgba(245,166,35,0.2)"}`,
                  display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden"
                }}>
                  {previews[doc.label] === "pdf"
                    ? <span style={{ color: "#ef4444", fontSize: "11px", fontWeight: "800" }}>PDF</span>
                    : previews[doc.label]
                      ? <img src={previews[doc.label]} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <p style={{ color: "#444", fontSize: "11px", margin: 0 }}>
                    {files[doc.label] ? `${(files[doc.label]!.size / 1024 / 1024).toFixed(2)} MB` : "PDF, JPG ou PNG â€” max 10MB"}
                  </p>
                </div>
        ...
        {error && (
          <div style={{
            ...
            borderLeft: "4px solid #ef4444", borderRadius: "12px",
        ...
        <button
          ...
          disabled={loading}
          style={{
            width: "100%", backgroundColor: loading ? "#333" : "#F5A623",
            color: loading ? "#666" : "#0D0D1A", border: "none",
