...
function formatPrix(p: number): string { return p.toLocaleString("fr-FR") + " FCFA"; }

export function RdvPasseTab({ instId, onToast }: { instId: string; onToast: (msg: string, color?: string) => void }) {
  ...
  return (
    <div style={{ padding: "16px", paddingBottom: "100px", animation: "fadeUp 0.2s ease" }}>
      ...
      {loading ? (
        ...
        <div style={{ backgroundColor: C.bgCard, borderRadius: "20px", padding: "44px 20px", textAlign: "center", border: `1px solid ${C.border}` }}>
