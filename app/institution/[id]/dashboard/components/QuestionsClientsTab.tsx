...
export function QuestionsClientsTab({ readOnly, onToast }: { readOnly: boolean; onToast: (msg: string, color?: string) => void }) {
  ...
  return (
    <div style={{ padding: "20px 16px" }}>
      ...
      {loading ? (
        <div style={{ padding: "48px", textAlign: "center", color: C.t3, fontSize: "13px" }}>Chargement…</div>
      ) : filtered.length === 0 ? (
              ...
              {q.reponse ? (
                ...
                <div style={{ display: "flex", gap: "8px" }}>
                  ...
                  <button
                    ...
                    className="tap"
                    style={{ backgroundColor: C.gold, color: "#000", border: "none", borderRadius: "10px", padding: "9px 16px", fontSize: "12.5px", fontWeight: "700", cursor: "pointer", opacity: envoiId === q.id ? 0.6 : 1, flexShrink: 0 }}
                  >
                    {envoiId === q.id ? "…" : "Répondre"}
                  </button>
                </div>
              ) : (
