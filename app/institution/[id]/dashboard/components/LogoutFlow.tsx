...
export function LogoutFlow({ onClose, redirectTo, copy }: {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 1200, backgroundColor: C.bg, display: "flex", alignItems: "center", justifyContent: "center", padding: "20px" }}>
      <style>{`@keyframes logoutSpin{to{transform:rotate(360deg)}} @keyframes logoutProgress{from{width:8%}to{width:92%}}`}</style>
      <div style={{ maxWidth: "360px", width: "100%", textAlign: "center" }}>
        {step === "transitioning" && (
          <>
            <div style={{ width: "56px", height: "56px", border: `3px solid ${C.gold}30`, borderTopColor: C.gold, borderRadius: "50%", animation: "logoutSpin 0.8s linear infinite", margin: "0 auto 22px" }}/>
